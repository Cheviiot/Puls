...
Скрипты скачиваются только из GitHub Releases, проверяют SHA-256 и не требуют
прав администратора. Готовый архив можно взять вручную на странице
[Releases](https://github.com/Cheviiot/Puls/releases).
